...
import { fetchPosts, fetchPostById, fetchPostsByTag, fetchTags, searchPosts } from './posts';
import { Post, PostFilterParams, PostsResponse } from '../model/types';
import { User } from '../../user/model/types';
import { fetchUsers } from '../../user/api/users';
